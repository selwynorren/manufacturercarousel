 ...
 *}
 <div class="panel">
	<h3><i class="icon icon-tags"></i> {l s='Manufacturers Carousel' mod='manufacturercarousel'}</h3>
	<p>
		<strong>{l s='Check out our Manufacturer\'s Logo Carousel!' mod='manufacturercarousel'}</strong><br />
